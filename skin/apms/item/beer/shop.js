...
function price_calculate()
{
    ...
    // var total_point = Math.round(total / 1.1);
    var total_point = Math.round(total * 0.1 / 1.1);
    // console.log(total);
    // console.log(total_point);

    $("#it_tot_price").empty().html(number_format(String(total))+"원");
    $("#it_tot_point").empty().html(number_format(String(total_point))+"A");
}
