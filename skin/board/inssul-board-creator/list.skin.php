							...
							<div class="list-item">
											...
											<div class="img-wrap item_thumbnail" style="padding-bottom:74.26%;">
												<div class="img-item">
																						...
																						<img src="http://localhost/data/file/creator/thumb-0_n8fzxgRE_a08caa660606aec355183baa8b18a4a56ac21fef_202x150.jpg" alt="" title="">
													</a>
												</div>
												<!-- //img -->
											</div>
								...
								<div class="list-content">
									...
									<div class="item_desc">
										<a href="http://localhost/bbs/board.php?bo_table=creator&amp;wr_id=59">
											<span class="text-muted">
												내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용···						</span>
										</a>
									</div>
									<!-- 게시물 설명 끝 -->
									...
									<div class="item_status">
											...
											<span class="s_interest">
													<i class="fa fa-eye" aria-hidden="true"></i> 1            </span>
											<span class="s_amond">
													<i class="icon-a-ball" aria-hidden="true"></i> 0            </span>
