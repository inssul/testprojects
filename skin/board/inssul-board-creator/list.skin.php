...
<section class="board-list<?php echo (G5_IS_MOBILE) ? ' font-14' : '';?>"> 
	...
	<div class="premium_exposure">
		...
		<div class="pagenation sub_title">
			<span id="currentSlide">1</span> / <span id="totalSlidePage"> 6</span>  <span>페이지</span>
		</div>
            ...
            <div class="swiper-wrapper">
                <div class="swiper-slide">
                    ...
                    <div class="list-row">
                        <div class="list-item">
                            <div class="imgframe">
                                <div class="img-wrap item_thumbnail" style="padding-bottom:74.26%;">
                                    <div class="img-item">
                                        <a href="http://localhost/bbs/board.php?bo_table=creator&amp;wr_id=59"><img src="http://localhost/data/file/creator/thumb-0_n8fzxgRE_a08caa660606aec355183baa8b18a4a56ac21fef_202x150.jpg" alt="" title=""></a>
                                    </div>
                                    <!-- //img -->
                                </div>
                                <!-- //date -->
                            ...
                            <div class="list-content">
                                ...
                                <div class="item_category">
                                    <span class="category_type">엔터테인먼트</span> <!-- 모든/지정 분류 · 지정 크리에이터 이름 -->
                                    <span class="creator_type target">지정 크리에이터 · </span>
                                    <span class="creator_name ">보겸</span>
                                    <span class="process">진행중</span>
                                    <span class="pull-right">
                                        <img src="/custom/images/bullet/bullet_exposure.jpg" alt="우선노출">
                                    </span>
                                </div>
                                <!-- 게시물 분류정보 끝 -->
                                <!-- 게시물 제목 시작 -->
                                <h2 class="item_title">
                                    <a href="http://localhost/bbs/board.php?bo_table=creator&amp;wr_id=59">제목제목제목제목제목</a>
                                </h2>
                                <!-- 게시물 제목 끝 -->
                                <!-- 게시물 설명 시작 -->
                                <div class="item_desc">
                                    <a href="http://localhost/bbs/board.php?bo_table=creator&amp;wr_id=59">
                                        <span class="text-muted">내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용내용···</span>
                                    </a>
                                </div>
                                <!-- 게시물 설명 끝 -->
                                <!-- 게시물 작성자 시작 -->
                                ...
                                <div class="item_status">
                                    <span class="s_comment">
                                        <i class="fa fa-comment" aria-hidden="true"></i><em>0</em>
                                    </span>
                                    <span class="s_like">
                                        <i class="fa fa-thumbs-up" aria-hidden="true"></i><em>0</em>
                                    </span>
                                    <span class="s_interest">
                                        <i class="fa fa-eye" aria-hidden="true"></i>1
                                    </span>
                                    <span class="s_amond">
                                        <i class="icon-a-ball" aria-hidden="true"></i>0
                                    </span>
                                    <a class="s_more_btn" href="http://localhost/bbs/board.php?bo_table=creator&amp;wr_id=59">More</a>
                                </div>
                                <!-- 게시물 상태정보 시작 -->
                            </div>
                            <!-- 게시물 컨텐츠 끝 -->
	...
	<!-- 일반노출 시작 -->
	<div class="list-wrap right_list">

		<div class="basic_exposure">
			<div class="title">일반노출</div>
			<div class="sub_title">
				<span>총</span> <em><?php echo number_format($total_count) ; ?></em> <span>건</span>
			</div>
		</div>
		...
		<ul class="dropdown-menu sort-drop" role="menu" aria-labelledby="sortLabel">
			...
			<a id="sortLabel" role="button" data-target="#" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="sort_btn">
			정렬방식:
				<?php 
					switch($sst) {
						case 'wr_datetime'	: echo '날짜순'; break;
						case 'wr_hit'		: echo '조회순'; break;
						case 'wr_good'		: echo '추천순'; break;
						case 'wr_nogood'	: echo '비추순'; break;
						case 'wr_comment'	: echo '댓글순'; break;
						case 'as_download'	: echo '다운순'; break;
						case 'as_poll'		: echo '참여순'; break;
						case 'wr_link1_hit'	: echo '방문순'; break;
						case 'as_update'	: echo '업데이트순'; break;
						case 'as_down'		: echo '다운점수순'; break;
						default				: echo '정렬'; break;
					}
				?>
				▼
			</a>
			<?php if ($list_href) { ?><a role="button" href="<?php echo $list_href ?>" class="btn btn-<?php echo $btn1;?> btn-sm">목록</a><?php } ?>
			<?php if ($write_href) { ?><a role="button" href="<?php echo $write_href ?>" class="write_btn">글쓰기</a><?php } ?>
		</div>
		<!-- // i_title -->
...
<script>
		...
		function SetPageNumber(nPageNumber) {
			document.querySelector("#currentSlide").innerHTML = nPageNumber;
		}

		var swiper = new Swiper('.premium_exposure .swiper-container', {
      ...
      navigation: {
		...
		console.log(document.querySelectorAll('.swiper-pagination-bullet').length)
