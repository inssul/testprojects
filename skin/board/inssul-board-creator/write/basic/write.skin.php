    ...
    <div class="f_ci">
        <div class="input-group date">
            <div class="date_start">
                 <input type="date" name="" value="<?php echo date('Y-m-d') ?>" class="form-control input-sm wr_term_start" id="wr_term_start"/>
            </div>
            <div class="date_end">
                <input type="date" name="wr_2" value="<?php echo $write['wr_2'] ? $write['wr_2'] : date("Y-m-d", strtotime("+90 day"));  ?>" class="form-control input-sm wr_term_end" id="wr_term_end" />
            </div>
        </div>
    </div>
</div>
...
<?php if ($is_category || $option) { ?>
    <?php if ($option) { ?>
        <div class="i_fg">
            <label class="f_cl hidden-xs"><?php echo (!$is_category) ? '' : '옵션';?></label>
            <div class="col-sm-7">
    ...
    <?php if ($is_category) { ?>
        <div class="i_fg ">
            <label class="f_cl hidden-xs"><?php echo ($is_category) ? '카테고리' : '';?></label>
            <div class="f_ci">
...
<div class="i_fg">
	...
	<div class="f_ci">
		<div class="input-group pay_post_group">
			...
			<button type="button" class="pay_post_btn " value="<?php echo date("Y-m-d", strtotime("+1 day"));?>" data-aboll="10">
					<span><b>1</b>일</span>
					<span><b>10</b> ABOLL</span>
			</button>
			<button type="button" class="pay_post_btn " value="<?php echo date("Y-m-d", strtotime("+3 day"));?>" data-aboll="30">
					<span><b>3</b>일</span>
					<span><b>30</b> ABOLL</span>
			</button>
			<button type="button" class="pay_post_btn " value="<?php echo date("Y-m-d", strtotime("+7 day"));?>" data-aboll="60">
					<span><b>7</b>일</span>
...
<div class="i_fg">
	...
	<div class="f_ci">
		<div class="input-group aball_counter i_count_number" id="writeCounter">
			<input type="number" value="10" data-own-aball="<?php echo $member['mb_point']; ?>" name="wr_1" id="wr_aball" max="<?php echo $member['mb_point'];?>" min="10" required class="form-control input-sm" size="50" maxlength="255"> <span class="hold_points">※ 보유 아몬드볼 <b><?php echo $member['mb_point'];?></b> ABOLL</span>
