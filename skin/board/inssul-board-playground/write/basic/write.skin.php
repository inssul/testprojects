...
<!-- 종목 시작 -->
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_category"><?php echo $board['bo_1_subj'] ?><strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
		<div class="input-group">
		<select name="wr_1" id="wr_category" class="input-sm" style="border-radius:0">
			<?php
...
<div class="form-group search_bj_group">
	<label class="col-sm-2 control-label" for="wr_search_bj"><?php echo $board['bo_2_subj'] ?></label>
	<div class="col-sm-10">
		<div class="input-group">
			<input type="number" name="wr_2" id="wr_search_bj" class="form-control input-sm" size="50" maxlength="255">
		</div>
	</div>
</div>
<!-- 땅콩볼 끝 -->
