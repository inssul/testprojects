...
<!-- 아몬드볼 필드 추가 시작 -->
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_aball"><?php echo $board['bo_1_subj'] ?><strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
		<div class="input-group">
			<input type="number" name="wr_1" id="wr_aball" max="<?php echo $member['mb_point'];?>" min="0" required class="form-control input-sm" size="50" maxlength="255">
		</div>
        <div class="">보유 포인트 <?php echo $member['mb_point'];?></div>
	</div>
</div>
<!-- 아몬드볼 필드 추가 끝 -->
...
<!-- 분류 필드 추가 시작 -->
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_category"><?php echo $board['bo_2_subj'] ?><strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
		<div class="input-group">
		<select name="wr_2" id="wr_category" class="input-sm" style="border-radius:0">
			<?php
...
<!-- 대상 필드 추가 시작 -->
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_target_bj"><?php echo $board['bo_3_subj'] ?><strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
		<div class="input-group">
		<select name="wr_3" id="wr_target_bj" class="input-sm" style="border-radius:0">
			<?php
...
<!-- 지정 선택 시 검색 필드 추가 시작 -->
<div class="form-group search_bj_group">
	<label class="col-sm-2 control-label" for="wr_search_bj"><?php echo $board['bo_4_subj'] ?></label>
	<div class="col-sm-10">
		<div class="input-group">
			<input type="text" name="wr_4" placeholder="지정 크리에이터를 검색합니다." id="wr_search_bj" class="form-control input-sm" size="50" maxlength="255">
		</div>
	</div>
</div>
<!-- 지정 선택 시 검색 필드 추가 끝 -->
...
<!-- 플랫폼 필드 추가 시작 -->
<div class="form-group">
	<label class="col-sm-2 control-label" for="wr_select_platform"><?php echo $board['bo_5_subj'] ?><strong class="sound_only">필수</strong></label>
	<div class="col-sm-10">
		<div class="input-group">
