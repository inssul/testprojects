...
<div class="i_login">
	...
	<div class="i_login_box">
		<div class="">
			...
			<input type="hidden" name="url" value='<?php echo $login_url ?>'>
				<div class="form-group has-feedback">
					...
					<input type="text" name="mb_id" id="login_id" placeholder="아이디를 입력해주세요." required class="form-control" size="20" maxLength="20">
					<!-- <span class="fa fa-user form-control-feedback"></span> -->
				</div>
				<div class="form-group has-feedback">
					<!-- <label for="login_pw"><b>비밀번호</b><strong class="sound_only"> 필수</strong></label> -->
					<input type="password" name="mb_password" id="login_pw" placeholder="비밀번호를 입력해주세요." required class="form-control" size="20" maxLength="20">
			...
			?>
				<div id="sns_login" class="sns-wrap-over">
					...
					<div class="sns_comment">SNS계정으로 간편하게 로그인하세요.</div>

					<div class="sns-wrap">
						<?php if( social_service_check('naver') ) {     //네이버 로그인을 사용한다면 ?>
						<a href="<?php echo $self_url;?>?provider=naver&amp;url=<?php echo $urlencode;?>" class="i_sns_icon social_link sns-naver" title="네이버">
						<a href="<?php echo $self_url;?>?provider=naver&amp;url=<?php echo $urlencode;?>" class="i_sns_icon social_link sns-naver" title="네이버">
							<!-- <span class="ico"></span> -->
						...
						<a href="<?php echo $self_url;?>?provider=kakao&amp;url=<?php echo $urlencode;?>" class="i_sns_icon social_link sns-kakao" title="카카오">
							<!-- <span class="ico"></span> -->
							<!-- <span class="txt">카카오<i> 로그인</i></span> -->
						</a>
						<?php }     //end if ?>
						<?php if( social_service_check('facebook') ) {     //페이스북 로그인을 사용한다면 ?>
						<a href="<?php echo $self_url;?>?provider=facebook&amp;url=<?php echo $urlencode;?>" class="i_sns_icon social_link sns-facebook" title="페이스북">
							<!-- <span class="ico"></span> -->
							<!-- <span class="txt">페이스북<i> 로그인</i></span> -->
						</a>
						<?php }     //end if ?>
						<?php if( social_service_check('google') ) {     //구글 로그인을 사용한다면 ?>
						<a href="<?php echo $self_url;?>?provider=google&amp;url=<?php echo $urlencode;?>" class="i_sns_icon social_link sns-google" title="구글">
							<!-- <span class="ico"></span> -->
							<!-- <span class="txt">구글+<i> 로그인</i></span> -->
						</a>
						<?php }     //end if ?>
						<?php if( social_service_check('twitter') ) {     //트위터 로그인을 사용한다면 ?>
						<a href="<?php echo $self_url;?>?provider=twitter&amp;url=<?php echo $urlencode;?>" class="i_sns_icon social_link sns-twitter" title="트위터">
							<!-- <span class="ico"></span> -->
							<!-- <span class="txt">트위터<i> 로그인</i></span> -->
						</a>
						<?php }     //end if ?>
						<?php if( social_service_check('payco') ) {     //페이코 로그인을 사용한다면 ?>
						<a href="<?php echo $self_url;?>?provider=payco&amp;url=<?php echo $urlencode;?>" class="i_sns_icon social_link sns-payco" title="페이코">
							<!-- <span class="ico"></span> -->
		...
		<div class="i_join_box">
			<a href="./register.php"></i> 회원가입</a>
		</div>
	</div>

	<div class="i_ads_box">
		로그인 시<br><br>배너 PHOTO
	</div>
...
// 페이지 로드시 배너 사이즈 맞춤
// (() => {
// 	const $loginArea = document.querySelector('.i_login')
// 	const $loginBox = $loginArea.querySelector('.i_login_box')
// 	const $bannerBox = $loginArea.querySelector('.i_ads_box')

// 	$bannerBox.style.height = $loginBox.offsetHeight + 'px'
// })()
</script>
<!-- } 로그인 끝 -->