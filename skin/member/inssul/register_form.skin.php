...
<?php } ?>
<div class="register_wrap form_skin">
	...
	<form class="form-horizontal register-form" role="form" id="fregisterform" name="fregisterform" action="<?php echo $action_url ?>" onsubmit="return fregisterform_submit(this);" method="post" enctype="multipart/form-data" autocomplete="off">
		...
		<div class="panel panel-default i_panel_form">
			<div class="panel-heading"><strong>기본정보입력</strong></div>
			<div class="panel-body i_panel_body">

			<div class="i_form_row">
				<div class="form-group text-gap">
					<label class="form_item_title control-label" for="reg_mb_id"><b>아이디</b><strong class="sound_only">필수</strong></label>
					<div class="form_item_input">
						<input placeholder="사용할 아이디를 입력해 주세요" type="text" name="mb_id" value="<?php echo $member['mb_id'] ?>" id="reg_mb_id" <?php echo $required ?> <?php echo $readonly ?> class="form-control input-sm" minlength="3" maxlength="20">
						<!-- <span class="fa fa-check form-control-feedback"></span> -->
					</div>
				</div>
				
				<div class="form-group">
					<div class="text-muted i_form_comment">
			...
			<div class="i_form_row">
				<div class="form-group" style="margin-bottom: 0;">
					<label class="form_item_title control-label" for="reg_mb_password"><b>비밀번호</b><strong class="sound_only">필수</strong></label>
					<div class="form_item_input" style="margin-bottom: 7px;">
						<input placeholder="사용할 비밀번호를 입력해 주세요." type="password" name="mb_password" id="reg_mb_password" <?php echo $required ?> class="form-control input-sm" minlength="3" maxlength="20">
						<!-- <span class="fa fa-lock form-control-feedback"></span> -->
						<div class="h15 hidden-lg hidden-md hidden-sm"></div>
					</div>
					<label class="form_item_title control-label" for="reg_mb_password_re"><b>비밀번호 확인</b><strong class="sound_only">필수</strong></label>
					<div class="form_item_input">
						<input placeholder="사용할 비밀번호를 재입력해 주세요." type="password" name="mb_password_re" id="reg_mb_password_re" <?php echo $required ?> class="form-control input-sm" minlength="3" maxlength="20">
						<!-- <span class="fa fa-check form-control-feedback"></span> -->
					</div>
				</div>
		...
		<div class="panel panel-default i_panel_form">
			...
			<div class="i_form_row">
				<div class="form-group <?php echo ($config['cf_cert_use']) ? ' text-gap' : '';?>">
					<label class="form_item_title control-label" for="reg_mb_name"><b>이름</b><strong class="sound_only">필수</strong></label>
					<div class="form_item_input">
			...
			<div class="i_form_row">
				...
				<?php if ($req_nick) {  ?>
					<div class="form-group text-gap">
						<label class="form_item_title control-label" for="reg_mb_nick"><b>닉네임</b><strong class="sound_only">필수</strong></label>
						<div class="form_item_input">
			...
			<div class="i_form_row">
				...
				<div class="form-group <?php echo ($config['cf_use_email_certify']) ? ' text-gap' : '';?>">
					<label class="form_item_title control-label" for="reg_mb_email"><b>E-mail</b><strong class="sound_only">필수</strong></label>
					<div class="form_item_input form_item_email">
						<input type="hidden" name="old_email" value="<?php echo $member['mb_email'] ?>" class="i_hide_dom">
						<input type="hidden" name="mb_email" value="<?php echo isset($member['mb_email'])?$member['mb_email']:''; ?>" id="reg_mb_email" class="form-control input-sm email i_hide_dom" size="70" maxlength="100">
					
						<input type="text" class="form-control input-sm email_id" require> 
						<span class="i_bullet_at"><i class="fa fa-at" aria-hidden="true"></i></span>
						<input type="text" class="form-control input-sm email_site" readonly require>
						<select class="email_site_selector">
				...
				<?php if ($config['cf_use_homepage']) {  ?>
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_homepage"><b>홈페이지</b><?php if ($config['cf_req_homepage']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="col-sm-5">
				...
				<?php if ($config['cf_use_tel']) {  ?>
					<div class="form-group has-feedback">
						<label class="form_item_title control-label" for="reg_mb_tel"><b>전화번호</b><?php if ($config['cf_req_tel']) { ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="col-sm-3">
				...
				<?php if ($config['cf_use_hp'] || $config['cf_cert_hp']) {  ?>
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_hp"><b>휴대폰번호</b><?php if ($config['cf_req_hp']) { ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="form_item_input">
				...
				<?php if ($config['cf_use_addr']) { ?>
					<div class="form-group has-feedback">
						<label class="form_item_title control-label"><b>주소</b><?php if ($config['cf_req_addr']) { ?><strong class="sound_only">필수</strong><?php }  ?></label>
						<div class="">
		...
		<div class="panel panel-default i_panel_form">
			...
			<div class="panel-body i_panel_body">
				...
				<?php if ($config['cf_use_signature']) {  ?>
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_signature"><b>서명</b><?php if ($config['cf_req_signature']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="">
				...
				<?php if ($config['cf_use_profile']) {  ?>
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_profile"><b>자기소개</b><?php if ($config['cf_req_profile']){ ?><strong class="sound_only">필수</strong><?php } ?></label>
						<div class="">
				...
				<?php if ($config['cf_use_member_icon'] && $member['mb_level'] >= $config['cf_icon_level']) {  ?>
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_profile"><b>회원아이콘</b></label>
						<div class="">
				...
				<?php }  ?>
					...
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_img"><b>회원이미지</b></label>
						<div class="">
				...
				?>
				<div class="optional_group">
				<div class="form-group">
					<label class="form_item_title control-label" for="reg_mb_mailling"><b>메일링서비스</b></label>
					<div class="">
				...
				<?php if ($config['cf_use_hp']) {  ?>
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_sms"><b>SMS 수신여부</b></label>
						<div class="">
							<label class="checkbox-inline">
				...
				<?php if (isset($member['mb_open_date']) && $member['mb_open_date'] <= date("Y-m-d", G5_SERVER_TIME - ($config['cf_open_modify'] * 86400)) || empty($member['mb_open_date'])) { // 정보공개 수정일이 지났다면 수정가능  ?>
					<div class="form-group">
						<label class="form_item_title control-label" for="reg_mb_open"><b>정보공개</b></label>
						<div class="">
							<label class="checkbox-inline">
				...
				<?php } else {  ?>
					<div class="form-group">
						<label class="form_item_title control-label"><b>정보공개</b></label>
						<div class="">
							<span class="help-block">
				...
				<?php if ($w == "" && $config['cf_use_recommend']) {  ?>
					<div class="form-group has-feedback">
						<label class="form_item_title control-label" for="reg_mb_recommend"><b>추천인아이디</b></label>
						<div class="col-sm-3">
				...
				<div class="form-group">
					<label class="form_item_title control-label"><b>자동등록방지</b></label>
					<div class="">
		...
		<div class="text-center" style="margin:30px 0px;">
			<button type="submit" id="btn_submit" class="join_submit_btn" accesskey="s"><?php echo $w==''?'회원가입':'정보수정'; ?></button>
			<?php if(!$pim) { ?>
				<a href="<?php echo G5_URL ?>" class="join_cancel_btn" role="button">취소</a>
			<?php } ?>
		</div>
