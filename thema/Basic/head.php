<link rel="stylesheet" href="/custom/fontello/css/fontello.css" type="text/css">
...
<div id="thema_wrapper" class="wrapper <?php echo $is_thema_layout;?> <?php echo $is_thema_font;?>">
		...
		<div class="at-container">
			...
			<div class="pull-right">
				<ul>
                    ...
                    <!-- creator check -->
                    <?php if($is_member) { // 로그인 상태 ?>
                        <?php if ($member['creators']) { // 인플루언서 신청 or 등록완료 ?>
                            <li class="apply_influ_btn"><a href="/bbs/page.php?hid=creator_join_step2">크리에이터</a></li>
                        <?php } else { // 인플루언서 신청페이지로 ?>
                            <li class="apply_influ_btn"><a href="/bbs/page.php?hid=creator_join_step1">크리에이터 등록하기</a></li>
                        <?php } ?>
                    <?php } else { // 로그아웃 상태 ?>
                        <li class="apply_influ_btn"><a href="/bbs/login.php" onclick="alert('로그인 후 시도해주세요.')">크리에이터 등록하기</a></li>
                    <?php } ?>
		...
		<div class="at-container">
			...
			<div class="header-logo">
				<a href="<?php echo $at_href['home'];?>">
					<img class="logo" src="/custom/images/logo.png" alt="인썰">
				</a>
			...
			<div class="header-search">
				...
				<div class="header-keyword">
					<?php echo apms_widget('basic-keyword', 'basic-keyword', 'q=유튜브,아프리카TV,트위치,카카오TV'); // 키워드 ?>
				</div>
			</div>
			<div class="clearfix"></div>
		</div>
	...
	<?php if($page_title) { // 페이지 타이틀 ?>
		<div class="ins_title">
			<div class="at-container">
				<div class="page-title en i_title">
