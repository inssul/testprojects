...
<div class="basic-outlogin">
	...
	<?php } else { //Logout ?>
		...
		<div class="login_box">
			<p>필요한 컨텐츠를 얻어보세요.</p>
			<a href="/bbs/login.php" class="login_btn">INSSUL 로그인</a>

			<div class="login_option">
				<a href="<?php echo $at_href['reg'];?>" class="join_btn">회원가입</a>
				<a href="<?php echo $at_href['lost'];?>" class="finder_btn">정보찾기</a>
			</div>
		</div>
