	...
	<div class="post-row">
		<div class="post-list">
			...
			<?php 
				...
				$wr_date = date('Y.m.d('.$week_w[date("w")].') H:i', strtotime($list[$i]['wr_datetime']))
			?>
				...
				<div class="extra_fields please">
					...
					<div class="item_category">
						<span><?php echo $list[$i]['wr_1'] ?></span> <!-- 종목 -->
						<span><?php echo $wr_date ?></span> <!-- 땅콩볼 -->
					</div>
					...
					<div class="item_status">
							...
							<span class="s_amond">
								<i class="icon-a-ball" aria-hidden="true"></i> <?php echo $list[$i]['wr_2']; ?>
							</span>
